...
export default class PsrCancelPermit extends LightningElement {
  @api applicationType;
  ...
  handleSubmit() {
    console.log("++++submitApplication++++++++++");
        this.dispatchEvent(
          new ShowToastEvent({
            title: "Success!!",
            message: "Your application for permit cancellation has been successfully submitted !!",
            variant: "success"
          })
        );
