...
import isForm1 from '@salesforce/apex/PsrNewPermitController.checkFormCriteria';

export default class PsrLicenseSelection extends LightningElement {
    ...
    activeForm;
    button2Style = 'slds-button license_button_disable slds-button_stretch';
    button1Style = 'slds-button license_button slds-button_stretch';
    ...
    handleNewPermit(event) {
        ...
        saveApp({
            ...
            .then(result => {
                ...
                _appId = result;
                window.open(`/psr/s/psrnewpermit?appId=${_appId}`, "_self");
    ...
    connectedCallback() {
        ...
        //         this.button2Style = 'slds-button license_button_disable slds-button_stretch';
        //         this.button1Style = 'slds-button license_button slds-button_stretch';
        //         this.button2Disabled = true;
        //         this.button1Disabled = false;
        //     } else if(this.activeForm == 'Form2'){
        //         this.button1Style = 'slds-button license_button_disable slds-button_stretch';
        //         this.button2Style = 'slds-button license_button slds-button_stretch';
        //         this.button2Disabled = false;
        //         this.button1Disabled = true;
        //     } else if(this.activeForm == 'Form12'){
        //         this.button1Style = 'slds-button license_button slds-button_stretch';
        //         this.button2Style = 'slds-button license_button slds-button_stretch';
        //         this.button2Disabled = false;
        //         this.button1Disabled = false;
