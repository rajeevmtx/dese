...
export default class PsrRequestAddressChange extends LightningElement {
  @api applicationType;
  ...
  handleSubmit() {
    console.log("++++submitApplication++++++++++");
        this.dispatchEvent(
          new ShowToastEvent({
            title: "Success!!",
            message: "Your request for address change has been successfully submitted !!",
            variant: "success"
          })
        );
