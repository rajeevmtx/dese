...
export default class PsrNavBarInspectionItem extends LightningElement {
    @api resultOptions=[];
    @api categoryOptions=[];
    ...
    /*connectedCallback(){
        const liAllItem = this.template.querySelectorAll('.all-item');
        liIliAllItemtem.classList.add('slds-is-active');
    }*/
}